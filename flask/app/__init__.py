...
def create_app(config_name):
    ...
    from flask.app.resources import Customers, CustomerList
    from flask.app.resources import Employees, EmployeeList
    from flask.app.resources import Offices, OfficeList
    from flask.app.resources import Orderdetails, OrderdetailList
    from flask.app.resources import Orders, OrderList
    from flask.app.resources import Payments, PaymentList
    from flask.app.resources import Productlines, ProductlineList
    from flask.app.resources import Products, ProductList
